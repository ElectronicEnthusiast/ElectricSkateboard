...
;* Date/Time created: Sun May 28 10:39:47 2017                 *
;***************************************************************
...
;	C:\ti\ccsv6\tools\compiler\ti-cgt-c2000_15.12.1.LTS\bin\opt2000.exe C:\\Users\\Keith\\AppData\\Local\\Temp\\127442 C:\\Users\\Keith\\AppData\\Local\\Temp\\127444 
;	C:\ti\ccsv6\tools\compiler\ti-cgt-c2000_15.12.1.LTS\bin\ac2000.exe -@C:\\Users\\Keith\\AppData\\Local\\Temp\\1274412 
	.sect	".text"
	.clink
	.global	_AdcSetMode
...
$C$DW$12	.dwtag  DW_TAG_variable
	.dwattr $C$DW$12, DW_AT_name("adcOffsetTrim")
	.dwattr $C$DW$12, DW_AT_TI_symbol_name("_adcOffsetTrim")
...
$C$DW$13	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$13, DW_AT_name("_CalAdcINL")
	...
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 32,column 3,is_stmt,isa 0
        ...
        B         $C$L1,EQ              ; [CPU_] |32| 
        ; branchcc occurs ; [] |32| 
        MOV       ACC,AR3 << #1         ; [CPU_] |32| 
        MOVL      XAR7,#459692          ; [CPU_U] |32| 
        ADD       AL,AR1                ; [CPU_] |32| 
        MOV       ACC,AL << #1          ; [CPU_] |32| 
        ADD       AL,AR2                ; [CPU_] |32| 
...
$C$L2:    
	...
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 82,column 4,is_stmt,isa 0
        MOV       AH,AR1                ; [CPU_] |82| 
        AND       AL,@_AdcdRegs+1,#0xffbf ; [CPU_] |82| 
        ANDB      AH,#1                 ; [CPU_] |82| 
        LSL       AH,6                  ; [CPU_] |82| 
        OR        AH,AL                 ; [CPU_] |82| 
        MOV       @_AdcdRegs+1,AH       ; [CPU_] |82| 
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 83,column 4,is_stmt,isa 0
        AND       AH,AR2,#0x0001        ; [CPU_] |83| 
        LSL       AH,7                  ; [CPU_] |83| 
        AND       AL,@_AdcdRegs+1,#0xff7f ; [CPU_] |83| 
        OR        AH,AL                 ; [CPU_] |83| 
        MOV       @_AdcdRegs+1,AH       ; [CPU_] |83| 
...
$C$L3:    
	...
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 69,column 4,is_stmt,isa 0
        MOV       AH,AR1                ; [CPU_] |69| 
        AND       AL,@_AdccRegs+1,#0xffbf ; [CPU_] |69| 
        ANDB      AH,#1                 ; [CPU_] |69| 
        LSL       AH,6                  ; [CPU_] |69| 
        OR        AH,AL                 ; [CPU_] |69| 
        MOV       @_AdccRegs+1,AH       ; [CPU_] |69| 
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 70,column 4,is_stmt,isa 0
        AND       AH,AR2,#0x0001        ; [CPU_] |70| 
        LSL       AH,7                  ; [CPU_] |70| 
        AND       AL,@_AdccRegs+1,#0xff7f ; [CPU_] |70| 
        OR        AH,AL                 ; [CPU_] |70| 
        MOV       @_AdccRegs+1,AH       ; [CPU_] |70| 
...
$C$L4:    
	...
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 56,column 4,is_stmt,isa 0
        MOV       AH,AR1                ; [CPU_] |56| 
        AND       AL,@_AdcbRegs+1,#0xffbf ; [CPU_] |56| 
        ANDB      AH,#1                 ; [CPU_] |56| 
        LSL       AH,6                  ; [CPU_] |56| 
        OR        AH,AL                 ; [CPU_] |56| 
        MOV       @_AdcbRegs+1,AH       ; [CPU_] |56| 
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 57,column 4,is_stmt,isa 0
        AND       AH,AR2,#0x0001        ; [CPU_] |57| 
        LSL       AH,7                  ; [CPU_] |57| 
        AND       AL,@_AdcbRegs+1,#0xff7f ; [CPU_] |57| 
        OR        AH,AL                 ; [CPU_] |57| 
        MOV       @_AdcbRegs+1,AH       ; [CPU_] |57| 
...
$C$L5:    
	...
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 43,column 4,is_stmt,isa 0
        MOV       AH,AR1                ; [CPU_] |43| 
        AND       AL,@_AdcaRegs+1,#0xffbf ; [CPU_] |43| 
        ANDB      AH,#1                 ; [CPU_] |43| 
        LSL       AH,6                  ; [CPU_] |43| 
        OR        AH,AL                 ; [CPU_] |43| 
        MOV       @_AdcaRegs+1,AH       ; [CPU_] |43| 
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 44,column 4,is_stmt,isa 0
        AND       AH,AR2,#0x0001        ; [CPU_] |44| 
        LSL       AH,7                  ; [CPU_] |44| 
        AND       AL,@_AdcaRegs+1,#0xff7f ; [CPU_] |44| 
        OR        AH,AL                 ; [CPU_] |44| 
        MOV       @_AdcaRegs+1,AH       ; [CPU_] |44| 
...
$C$DW$16	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$16, DW_AT_name("CalAdcINL")
	.dwattr $C$DW$16, DW_AT_low_pc(_CalAdcINL)
	.dwattr $C$DW$16, DW_AT_high_pc(0x00)
	.dwattr $C$DW$16, DW_AT_TI_symbol_name("_CalAdcINL")
	.dwattr $C$DW$16, DW_AT_external
	.dwattr $C$DW$16, DW_AT_TI_begin_file("C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c")
...
$C$DW$17	.dwtag  DW_TAG_formal_parameter
	...
	.dwattr $C$DW$17, DW_AT_TI_symbol_name("_adc")
...
$C$L7:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c",line 124,column 4,is_stmt,isa 0
        ...
        MOVZ      AR6,*+XAR4[0]         ; [CPU_] |124| 
        MOVL      XAR4,#65535           ; [CPU_U] |124| 
        MOVL      ACC,XAR4              ; [CPU_] |124| 
        CMPL      ACC,XAR6              ; [CPU_] |124| 
        B         $C$L10,EQ             ; [CPU_] |124| 
        ; branchcc occurs ; [] |124| 
...
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$22, DW_AT_TI_return
        ...
        LRETR     ; [CPU_] 
        ; return occurs ; [] 
	.dwattr $C$DW$16, DW_AT_TI_end_file("C:/ti/controlSUITE/device_support/F2837xD/v170/F2837xD_common/source/F2837xD_Adc.c")
	.dwattr $C$DW$16, DW_AT_TI_end_line(0x8e)
...
$C$DW$630	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$630, DW_AT_name("R2HL")
	.dwattr $C$DW$630, DW_AT_location[DW_OP_regx 0x33]

$C$DW$631	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$631, DW_AT_name("R2H")
	.dwattr $C$DW$631, DW_AT_location[DW_OP_regx 0x34]

$C$DW$632	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$632, DW_AT_name("R3HL")
	.dwattr $C$DW$632, DW_AT_location[DW_OP_regx 0x37]

$C$DW$633	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$633, DW_AT_name("R3H")
	.dwattr $C$DW$633, DW_AT_location[DW_OP_regx 0x38]

$C$DW$634	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$634, DW_AT_name("R4HL")
	.dwattr $C$DW$634, DW_AT_location[DW_OP_regx 0x3b]

$C$DW$635	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$635, DW_AT_name("R4H")
	.dwattr $C$DW$635, DW_AT_location[DW_OP_regx 0x3c]

$C$DW$636	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$636, DW_AT_name("R5HL")
	.dwattr $C$DW$636, DW_AT_location[DW_OP_regx 0x3f]

$C$DW$637	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$637, DW_AT_name("R5H")
	.dwattr $C$DW$637, DW_AT_location[DW_OP_regx 0x40]

$C$DW$638	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$638, DW_AT_name("R6HL")
	.dwattr $C$DW$638, DW_AT_location[DW_OP_regx 0x43]

$C$DW$639	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$639, DW_AT_name("R6H")
	.dwattr $C$DW$639, DW_AT_location[DW_OP_regx 0x44]

$C$DW$640	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$640, DW_AT_name("R7HL")
	.dwattr $C$DW$640, DW_AT_location[DW_OP_regx 0x47]

$C$DW$641	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$641, DW_AT_name("R7H")
	.dwattr $C$DW$641, DW_AT_location[DW_OP_regx 0x48]

$C$DW$642	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$642, DW_AT_name("RBL")
	.dwattr $C$DW$642, DW_AT_location[DW_OP_regx 0x49]

$C$DW$643	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$643, DW_AT_name("RB")
	.dwattr $C$DW$643, DW_AT_location[DW_OP_regx 0x4a]

$C$DW$644	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$644, DW_AT_name("STFL")
	.dwattr $C$DW$644, DW_AT_location[DW_OP_regx 0x27]

$C$DW$645	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$645, DW_AT_name("STF")
	.dwattr $C$DW$645, DW_AT_location[DW_OP_regx 0x28]

$C$DW$646	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$646, DW_AT_name("FPUHAZ")
	.dwattr $C$DW$646, DW_AT_location[DW_OP_reg27]
